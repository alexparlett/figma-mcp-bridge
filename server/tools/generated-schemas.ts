...
export const generatedTools: ToolSchema[] = [
  ...
  // figma_component_from_node
  {
    ...
    inputSchema: {
        ...
        "properties": {
            ...
            "allPages": {
                "type": "boolean",
                "description": "Search across all pages instead of just the current page. Default: false"
            },
            "nodeId": {
                "type": "string"
            },
  ...
  // figma_flatten_node
  {
    ...
    inputSchema: {
        ...
        "additionalProperties": false,
        "description": "Reference to a node by ID or name, with query options for serialization.",
        "definitions": {
            "SerializableProp": {
                "type": "string",
                "enum": [
